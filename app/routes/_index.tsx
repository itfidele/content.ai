    ...
    return <Flex h={"100vh"} px={6} bg={"#000000"} w={"full"} direction={"column"} gap={10} >
            <Flex alignItems={"center"} justifyContent={"center"} p={4}>
                ...
                <Flex alignItems={"center"} justifyContent={"center"}>
                    <Button disabled={loading} as={Link} to={'/content'}  _hover={{bg:"blue.600",color:"gray.50"}} bg={"#2770FF"} color={"white"}>Get Started</Button>
                </Flex>
            </Flex>
        <Container as={Flex} direction={"column"} gap={10} alignItems={"center"} justifyContent={"center"} minW={"7xl"} h={"70vh"}>
            ...
            <Button as={Link} disabled={loading} to={'/content'}  bg={"#2770FF"} color={"white"} size={"md"} _hover={{bg:"blue.600",color:"gray.50"}} rounded={"lg"}>Try It for Free</Button>
        </Container>
    </Flex>
}